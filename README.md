<img
  src="https://raw.githubusercontent.com/flexda/flexda/main/assets/daily-hero/shopping-collage-2.jpg"
...
`건축·도시의 문제 관찰` → `데이터 분석` → `업무 자동화` → `AI 에이전트와 협업`

## How I work

`발견` → `작은 실험` → `결과 확인` → `막힌 이유 기록` → `다음 개선`

---

### [포트폴리오 보기 →](https://flexda.github.io/flexda-github-renew/)
